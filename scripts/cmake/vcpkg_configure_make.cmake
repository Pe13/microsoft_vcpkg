...
function(vcpkg_configure_make)
    ...
    if(VCPKG_TARGET_IS_APPLE)
        if (NOT arg_BUILD_TRIPLET OR arg_DETERMINE_BUILD_TRIPLET)
        ...
        if(NOT CMAKE_HOST_APPLE AND NOT requires_autoconfig)
            list(APPEND arg_OPTIONS "--target-os=darwin")
        endif()
    endif()
    ...
    if (VCPKG_TARGET_IS_WINDOWS)
        ...
        if(VCPKG_DETECTED_CMAKE_STRIP) # If required set the ENV variable STRIP in the portfile correctly
            ...
            z_vcpkg_append_to_configure_environment(configure_env STRIPPROG "${VCPKG_DETECTED_CMAKE_STRIP}")
            z_vcpkg_append_to_configure_environment(configure_env INSTALL_STRIP_PROGRAM "${VCPKG_DETECTED_CMAKE_STRIP}")
            z_vcpkg_append_to_configure_environment(configure_env INSTALL_PROGRAM "/usr/bin/install --strip-program=${VCPKG_DETECTED_CMAKE_STRIP}")
            list(APPEND arg_OPTIONS ac_cv_prog_STRIP=${VCPKG_DETECTED_CMAKE_STRIP} ac_cv_prog_ac_ct_STRIP=${VCPKG_DETECTED_CMAKE_STRIP})
        else()
